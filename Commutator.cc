...
//   Operator Z(*(Y.modelspacea),ZJ,ZTrank,Zparity,Zpart);
   Operator Z(ms,ZJ,ZTrank,Zparity,Zpart);
...
//               std::cout << "SixJ = " << Z.modelspace->GetSixJ(J2,J1,Lambda,ji,ja,jj) << std::endl;
