...
//      .def("GetTBME_J_norm", TB_GetTBME_J_norm)
      .def("SetTBME",[](TwoBodyME& self, int ch_bra, int ch_ket, int a, int b, int c, int d, double tbme){return self.SetTBME(ch_bra,ch_ket,a,b,c,d,tbme);} )
...
//  ;
   ...
   m.def("ISDipoleOp", imsrg_util::ISDipoleOp);
